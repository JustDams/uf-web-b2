 ...
 */
final class Version20200605171538 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE games CHANGE release_year release_year DATE NOT NULL, CHANGE stock stock INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE games CHANGE release_year release_year INT NOT NULL, CHANGE stock stock INT DEFAULT NULL');
