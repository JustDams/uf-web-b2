 ...
 */
final class Version20200605122051 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD username VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE games CHANGE stock stock INT DEFAULT NULL');
        $this->addSql('ALTER TABLE users DROP username, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`');
    }
}
